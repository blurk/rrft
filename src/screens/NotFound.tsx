...
import { ReactComponent as Cover } from '../assets/images/bg.svg';

export default function NotFound() {
	return (
		<div className='relative h-screen overflow-hidden bg-indigo-900'>
			<Cover className='absolute object-cover w-full h-full' />
			...
			<div className='container relative z-10 flex items-center px-6 py-32 mx-auto md:px-12 xl:py-40'>
				<div className='relative z-10 flex flex-col items-center w-full font-mono'>
					...
					<Link
						to='/'
						className='my-5 text-2xl font-extrabold text-white transition duration-200 ease-in hover:text-gray-500 '>
						Back to Home
					</Link>
